...
const CreditCard = () => {
  ...
  return (
    <Tilt
      ...
      className={`${shareTechMono.className} w-[425px] h-[270px] max-sm:w-[300px] max-sm:h-[189px] bg-gradient-to-tr rounded-2xl flex content-center items-center justify-center from-[#9C2CF3] to-[#3A49F9] `}
    >
      <div className='w-full h-full  p-8 max-sm:p-2 relative '>
        ...
        <div
          ...
          style={{
            textShadow:
              '-1px -1px 0px rgba(255,255,255,0.3), 1px 1px 0px rgba(0,0,0,0.8)',
          }}
        >
